...
os.makedirs(f"{images_path}/static", exist_ok=True)
os.makedirs(f"{images_path}/varying_c1", exist_ok=True)
os.makedirs(f"{images_path}/varying_c2", exist_ok=True)
...
def sample_image(n_row, epoch):
    ...
    save_image(static_sample.data, f"{images_path}/static/{epoch}.png", nrow=n_row, normalize=True)
    ...
    save_image(sample1.data, f"{images_path}/varying_c1/{epoch}.png" , nrow=n_row, normalize=True)
    save_image(sample2.data, f"{images_path}/varying_c2/{epoch}.png", nrow=n_row, normalize=True)
